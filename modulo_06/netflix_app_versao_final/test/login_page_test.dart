...
import 'package:netflix_app/login/presentation/views/login_view.dart';
...
void main() {
  ...
  Widget makeSut() => MaterialApp(home: LoginView(controller: controller));

  setUp(() {
    counter = 0;
    controller = LoginControllerMock();
  });
